...
<body>
    ...
    <div class="summary">
        <div class="summary-item">
            ...
            <span class="value">{{ number_format($totalStok, 0, ',', '.') }}</span> unit
        </div>
        <div class="summary-item">
            <strong>Nilai Total:</strong><br>
            <span class="value">Rp {{ number_format($totalValue, 0, ',', '.') }}</span>
        </div>
    </div>
        ...
        <tbody>
            @forelse($stokWithValue as $stok)
                <tr>
                    ...
                    <td class="text-right">{{ number_format($stok->stok, 0, ',', '.') }}</td>
                    <td class="text-right">Rp {{ number_format($stok->barang->harga ?? 0, 0, ',', '.') }}</td>
                    <td class="text-right">Rp {{ number_format($stok->total_value, 0, ',', '.') }}</td>
                </tr>
            @empty
                <tr>
